              ...
              <div class="col-md-12">
                <div class="card card-default">
                  <div class="card-header flex gp--2">
                    <h3 class="card-title" style="align-self: center;">Special Trust Fund</h3>
                    <input type="hidden" name="stf_year" style="text-align:center;" placeholder="Year" required>
                    <?php
                    ...
                    <div class="bs-stepper">
                      ...
                      <div class="bs-stepper-content">
                        ...
                        <div id="response-part" class="content" role="tabpanel" aria-labelledby="response-part-trigger">
                          ...
                          <button type="button" class="btn btn-primary" onclick="stepper.previous()">Previous</button>
                          <button type="submit" name="stfForm" class="btn btn-primary">Submit</button>
                        </div>
...
<script>
  ...
  const dateInput = document.getElementsByName('stf_year')[0];
