                          ...
                          <table border='0' cellpadding='0' cellspacing='0' width='1190' style='border-collapse:collapse;
                            ...
                            <tr height='20' style='mso-height-source:userset;height:15pt'>
                              ...
                              <td colspan='9' class='x46'>
                                ...
                                <input type="date" name="genfund_year" value="<?php echo $_GET['genfund_year'] ?>" style="text-align:center;" placeholder="Year" required>
                        ...
                        <body link='blue' vlink='purple'>
                          ...
                          <table border='0' cellpadding='0' cellspacing='0' width='1007' style='border-collapse:collapse;
                            ...
                            <div class="prevmt__row" id="prevMt">
                              <?php
                              $conn = new mysqli('localhost', 'root', '', 'mdrsystem');
                              $query = mysqli_query($conn, "SELECT * FROM `tbl_genfund` WHERE `prog_type` = 'prevention' AND `reference_id` = $genID");
                              while ($result = mysqli_fetch_array($query)) {
                                extract($result);
                              ?>
                                <tr height='54' style='mso-height-source:userset;height:40.5pt' id="prevMtRow">
                                  <td height='52' class='x34' style='height:39pt;'>
                                    <!-- <input type="hidden" id="deletebtn" e class="general_updat" name="prog_ids[]" style="height: 32px;width: 30px;border: 1px solid #fff;outline:0;" value="<?php echo $prog_id; ?>"> -->

                                    <button data-ref-id="<?php echo $reference_id?>" data-prog-id="<?php echo $prog_id ?>" id="deleterow" class="deleterow" style="border:none;outline:none;background:none"><i class="fa-solid fa-minus"></i></button>
                                  </td>
                                  ...
                                  <td class="x38">
                                    <div class="flex flex-justify--center flex-align--center" style="height:5rem">
                                      <input type="number" name="remark_one[]" style="height: 51px;width: 80px;border: 1px solid #fff;outline: 0;text-align: center;" value="<?php echo $remarks ?>"
                            ...
                            <div class="preparedness_row">
                              <?php
                              $conn = new mysqli('localhost', 'root', '', 'mdrsystem');
                              $query = mysqli_query($conn, "SELECT * FROM `tbl_genfund` WHERE `prog_type` = 'preparedness' AND `reference_id` = $genID");
                              while ($result = mysqli_fetch_array($query)) {
                                extract($result);
                              ?>
                            ...
                            <div class="support__row">
                              <?php
                              $conn = new mysqli('localhost', 'root', '', 'mdrsystem');
                              $query =  mysqli_query($conn, "SELECT * FROM `tbl_genfund` WHERE `prog_type` = 'support' AND `reference_id` = $genID ");
                              while ($result = mysqli_fetch_array($query)) {
                                extract($result);
                              ?>
                            ...
                            <div class="response__row">
                              <?php
                              $conn = new mysqli('localhost', 'root', '', 'mdrsystem');
                              $query =  mysqli_query($conn, "SELECT * FROM `tbl_genfund` WHERE `prog_type` = 'response' AND `reference_id` = $genID ");
                              while ($result = mysqli_fetch_array($query)) {
                                extract($result);
                              ?>
