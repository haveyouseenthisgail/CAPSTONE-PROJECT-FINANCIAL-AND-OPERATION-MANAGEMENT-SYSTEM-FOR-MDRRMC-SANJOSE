...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="dvvat__head" style="margin-top: 0.5rem;margin-bottom:0.5rem;">
          <p style=" display:inline-block;font-size: 1.4rem;margin: unset;background-color: #007bff;color:#fff;padding:0.2rem;">DV (VATable) Form</p>
        </div>
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-10">
              <div class="main_wrapper  flex flex-justify--center">
                  ...
                  <input type="hidden" name="dvtype" value="dvvat">
                    <table border='0' cellpadding='0' cellspacing='0' width='824' style='border-collapse:separate;
                      ...
                      <tr height='24' class='x22' style='mso-height-source:userset;height:18pt'>
                        ...
                        <td class='x23'> <button type="submit" style="display:none;" >SUBMIT</button> </td>
                      </tr>
                      <tr height='24' class='x22' style='mso-height-source:userset;height:18pt'>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td rowspan='2' height='40' class='x146 flex flex-align--center ' style='border-bottom:1px solid windowtext;height:30pt;'>
                          ...
                          <input type="text" name="dv_fund" placeholder="Fund" required>
                        </td>
                      </tr>
                      ...
                      <tr height='27' style='mso-height-source:userset;height:20.25pt'>
                        ...
                        <td class='x33'>
                          <p>DV No.:<input name="dv_no" placeholder="DV No" required type="text"></p>
                        </td>
                        <td></td>
                      </tr>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td class='x37'>
                          ...
                          $now = $date;
                          ?>
                          <p>Date <input name="dv_date" placeholder="Date" type="date" required value="<?php echo $now ?>" id="dv_date"> </p>
                        </td>
                        <td></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td colspan='6' rowspan='2' height='41' class='x142' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;height:30.75pt;overflow:hidden;'>
                          <input name="dv_payee" placeholder="Payee" required type="text" class="payee__field">
                        </td>
                        <td class='x38'>
                          <p>ID No./TIN: <input name="dv_tin" placeholder="ID No./TIN" required type="text"></p>
                        </td>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td colspan='6' rowspan='2' height='42' class='x142' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;border-right:1px solid windowtext;height:31.5pt;'>
                          <input name="dv_add" placeholder="Address" required type="text" class="address__field">
                        </td>
                        <td class='x39 flex flex-direction--col flex-align--center' style="border-left: 1px solid windowtext;border-bottom: unset !important;border-top: 1px solid windowtext;">
                          ...
                          <input name="dv_rcenter" placeholder="Responsibility Center" required type="text" class="center__field">
                        </td>
                        <td></td>
                      </tr>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td colspan='7' rowspan='4' height='82' class='x165' style='border-right:1px solid windowtext;height:62.1pt;'>
                          <input type="text" class="particulars__area" name="dv_particulars" placeholder="Particulars" style="vertical-align:top;">
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        <td rowspan='3' height='61' class='x164' x:num='9900' style='height:46.35pt;'><span style='mso-spacerun:yes;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </span><input name="dv_amnt" placeholder="Amount" required type="number">&nbsp; </td>
                        <td></td>
                      </tr>
                      ...
                      <tr height='22' style='mso-height-source:userset;height:16.5pt'>
                        ...
                        <td class='x63' style="border-left: 1px solid windowtext;border-bottom: 2px solid windowtext;" align='right' x:num='9900' x:fmla='=SUM(H18-F23)'><span style='mso-spacerun:yes;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </span><input name="dv_amntdue" placeholder="Amount Due" required type="number">&nbsp;</td>
                        <td></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <div class="form-group" style="margin: unset;">
                            <select class="form-control select2" style="width: 100%;" name="a_name">
                              <?php
                              $fetch_authorizer = fetch_authorizer($conn);
                              while ($result = mysqli_fetch_array($fetch_authorizer)) {
                                extract($result);
                              ?>
                                <option value="<?php echo $authorizer_id ?>" selected="selected"><?php echo $authorizer_name . '  ' . $authorizer_id ?></option>
                              <?php } ?>
                            </select>
                          </div>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <div class="form-group" style="margin: unset;">
                            <select class="form-control select2" style="width: 100%;" name="d_name">
                              <?php
                              $fetch_authorizer = fetch_authorizer($conn);
                              while ($result = mysqli_fetch_array($fetch_authorizer)) {
                                extract($result);
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <div class="form-group" style="margin: unset;">
                            <select class="form-control select2" style="width: 100%;" name="f_name">
                              <?php
                              $fetch_authorizer = fetch_authorizer($conn);
                              while ($result = mysqli_fetch_array($fetch_authorizer)) {
                                extract($result);
                      ...
                      <tr height='22' style='mso-height-source:userset;height:16.5pt'>
                        <td colspan='4' height='20' class='x105' style='border-right:1px solid windowtext;border-bottom:2px solid windowtext;height:15pt;'></td>
  ...
  <script>
    ...
    document.getElementById('dv_date').addEventListener('change', function() {
