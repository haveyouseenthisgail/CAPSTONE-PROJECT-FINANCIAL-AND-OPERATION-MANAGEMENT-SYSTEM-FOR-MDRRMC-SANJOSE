...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <form action="../inc/controller.php" method="POST" id="UpdategenfundForm">
        <?php
              ...
              <div class="col-md-12">
                <div class="card card-default">
                  <div class="card-header flex gp--2">
                    ...
                    <input type="date" name="genfund_year" value="<?php echo $_GET['genfund_year'] ?>" readonly style="text-align:center;outline:0;border:none;" placeholder="Year">

                    <?php
                    $conn = new mysqli('localhost', 'root', '', 'mdrsystem');

                    $queryFund = $conn->query("SELECT * FROM `tbl_fundallotment` WHERE `reference_id` = '$genID' AND `fund_type` = 'Genfund'");
                    $resultFund = $queryFund->fetch_assoc();
                    $fundAllotment = $resultFund['fund_allotmentbal'] ?? 0;
                    $theref = $resultFund['reference_id'] ?? '';

                    $getid = $conn->query("SELECT `fallotment_id` FROM `tbl_genfund` WHERE `reference_id` = '$genID'");
                    ...
                    <div class="bs-stepper">
                      ...
                      <div class="bs-stepper-content">
                        ...
                        <div id="response-part" class="content" role="tabpanel" aria-labelledby="response-part-trigger">
                          ...
                          <button type="button" class="btn btn-primary" onclick="stepper.previous()">Previous</button>
                          <button type="submit" name="UpdategenfundForm" class="btn btn-primary">Submit</button>
                        </div>
