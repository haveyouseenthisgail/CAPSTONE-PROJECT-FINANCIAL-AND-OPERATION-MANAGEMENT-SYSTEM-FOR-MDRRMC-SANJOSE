                          ...
                          <table border='0' cellpadding='0' cellspacing='0' width='1190' style='border-collapse:collapse;
                            ...
                            <tr height='20' style='mso-height-source:userset;height:15pt'>
                              <td colspan='3' height='20' class='x21' style='mso-ignore:colspan;height:15pt;'>
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM `tbl_fundallotment` WHERE `fund_type` = 'Stf' AND `reference_id` IS NULL");
                              ...
                              <td colspan='9' class='x46'>
                                ...
                                <input type="date" name="stf_year" style="text-align:center;" placeholder="Year" required>
                                ANNUAL INVESTMENT PROGRAM (AIP)
                              </td>
                              <td colspan='2' class='x22' style='mso-ignore:colspan;'></td>
                            </tr>
                            <tr height='20' style='mso-height-source:userset;height:15pt'>
                              <td colspan='3' height='20' class='x21' style='mso-ignore:colspan;height:15pt;'><input type="number" class="funds__remaining" id="remaining-funds" style="outline:0;border:1px solid #fff;text-align:center;" readonly name="funds_remaining" inputmode="numeric" pattern="[0-9]*"></td>
