    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row mb-2">
            <div class="col-sm-6">
              <div class="dvnvat__head">
                <p style="    font-size: 2rem;margin: unset;">DV View</p>
              </div>
            </div>
            <div class="col-sm-6">
                    ...
                    <table border='0' cellpadding='0' cellspacing='0' width='824' style='border-collapse:separate;
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td rowspan='2' height='40' class='x146 flex flex-align--center ' style='border-bottom:1px solid windowtext;height:30pt;'>
                          ...
                          <input name="dv_fund" placeholder="Fund" required type="text" value="<?php echo $dv_fund ?>" readonly>
                      ...
                      <tr height='27' style='mso-height-source:userset;height:20.25pt'>
                        ...
                        <td class='x33'>
                          <p>DV No.:<input name="dv_no" placeholder="DV No." required type="text" value="<?php echo $dv_no ?>" readonly></p>
                        </td>
                        <td></td>
                      </tr>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td class='x37'>
                          ...
                          ?>
                          <p>Date <input name="dv_date" placeholder="Date" required type="date" value="<?php echo $dv_date ?>" readonly></p>
                        </td>
                        <td></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td colspan='6' rowspan='2' height='41' class='x142' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;height:30.75pt;overflow:hidden;'>
                          <input name="dv_payee" placeholder="Payee" required type="text" class="payee__field" id="dv_payee" value="<?php echo $dv_payee ?>" readonly>
                        </td>
                        <td class='x38'>
                          <p>ID No./TIN: <input name="dv_tin" placeholder="ID No./TIN:" required type="text" id="dv_tin" value="<?php echo $dv_tin ?>" readonly></p>
                        </td>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td class='x37 cafoa__inputs' style="border-bottom: 1px solid windowtext;">
                          <p>CAFOA No.:
                            <input name="dv_cafoa" placeholder="CAFOA No" required type="text"
                              value="<?php echo $dv_cafoa ?>" readonly>
                          </p>
                        </td>
                        <td></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td colspan='6' rowspan='2' height='42' class='x142' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;border-right:1px solid windowtext;height:31.5pt;'>
                          <input name="dv_add" placeholder="Address" required type="text" class="address__field" value="<?php echo $dv_add ?>" readonly>
                        </td>
                        <td class='x39 flex flex-direction--col flex-align--center' style="border-left: 1px solid windowtext;border-bottom: unset !important;border-top: 1px solid windowtext;">
                          ...
                          <input name="dv_rcenter" placeholder="Responsibility Center " required type="text" class="center__field" value="<?php echo $dv_rcenter ?>" readonly>
                        </td>
                        <td></td>
                      </tr>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td colspan='7' rowspan='4' height='82' class='x165' style='border-right:1px solid windowtext;height:62.1pt;'>
                          <input type="text" class="particulars__area" name="dv_particulars" placeholder="Particulars" required value="<?php echo $dv_particulars ?>" readonly>
                        </td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        <td rowspan='3' height='61' class='x164' x:num='9900' style='height:46.35pt;'><span style='mso-spacerun:yes;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </span><input name="dv_amnt" placeholder="Amount" required type="number"
                            value="<?php echo $dv_amnt ?>" readonly>&nbsp;</td>
                        <td></td>
                      </tr>
                      ...
                      <tr height='22' style='mso-height-source:userset;height:16.5pt'>
                        ...
                        <td class='x63' style="border-left: 1px solid windowtext;border-bottom: 2px solid windowtext;" align='right' x:num='9900' x:fmla='=SUM(H18-F23)'><span style='mso-spacerun:yes;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </span><input name="dv_amntdue" placeholder="Amount Due" required type="number" value="<?php echo $dv_amntdue ?>" readonly>&nbsp;</td>
                        <td></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td colspan='3' height='21' class='x139' style='border-right:1px solid windowtext;height:15.75pt;'>&nbsp;
                          ...
                          <?php
                          $level_fields = ['level_a', 'level_b', 'level_c', 'level_d', 'level_e', 'level_f1', 'level_f2'];
                          $authorizer_name = [];

                          foreach ($level_fields as $field) {
                            $sql = mysqli_query($conn, "SELECT tbl_authorizers.authorizer_name
                            FROM tbl_authorizers  
                            INNER JOIN tbl_level_auth 
                            ON tbl_authorizers.authorizer_id = tbl_level_auth.$field 
                            WHERE tbl_level_auth.dv_id = $_GET[dv_id]");
                            if ($row = mysqli_fetch_array($sql)) {
                              $authorizer_name[$field] = $row['authorizer_name'];
                            } else {
                              $authorizer_name[$field] = '';
                            }
                          }
                          ?>
                          <input type="text" style="text-align: center;font-weight:600;" readonly name="a_name" value="<?php echo $authorizer_name['level_a']; ?>">

                        </td>


                        <td colspan='3' class='x162' style='border-right:1px solid windowtext;'>
                          <input type="text" style="width:19rem;text-align:center;font-weight:600;" value="<?php echo $authorizer_name['level_b'] ?>" readonly name="b_name">
                        </td>
                        <td colspan='2' class='x162' style='border-right:2px solid windowtext;'>
                          <input type="text" style="text-align: center; width:15.5rem;font-weight:600;" value="<?php echo $authorizer_name['level_c']  ?>" readonly name="c_name">
                        </td>
                        <td></td>
                      </tr>
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                          ...
                          <span style='mso-ignore:vglayout2'>
                            <div class="c__position">
                              <table cellpadding='0' cellspacing='0' class="  flex flex-justify--center" style="border-left: 1px solid #000;height:27px ;">
                                <tr>
                                  <td colspan='2' height='20' class='x160' width='221' style='height:15pt;width:165.75pt;border-left:unset;'>
                                   
                                    <p style="display: inline-block;border-top: 1px solid #000;text-align: center;width: 14rem;">Municipal Treasurer</p>
                                  </td>
                                </tr>
                              </table>
                            </div>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        ...
                        <td colspan='2' rowspan='3' height='63' class='x169' x:fmla='=B11' style='border-right:2px solid windowtext;border-bottom:1px solid windowtext;height:47.25pt;'>
                          <input type="text" value="<?php echo $authorizer_name['level_e'] ?>" style="text-align:center;font-weight:600;" readonly name="e_name">
                        </td>
                        <td></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td colspan='3' height='20' class='x148' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;height:15pt;'>
                          <input type="text" style="width: 18rem; height:22px;text-align:center;font-weight:600;" value="<?php echo $authorizer_name['level_d'] ?> " readonly name="d_name">
                        </td>
                      ...
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td colspan='4' height='21' class='x102' style='border-right:1px solid windowtext;height:15.75pt;'>
                        <input type="text" style="width:18rem;border-bottom:1px solid;text-align:center;font-weight:600;" value="<?php echo $authorizer_name ['level_f1']?>" readonly>
                        </td>
                        <td colspan='4' class='x108' style='border-right:2px solid windowtext;'>
                          <input type="text" style="width: 15rem;border-bottom:1px solid;text-align:center;font-weight:600;" value="<?php echo $authorizer_name['level_f2'] ?>" readonly name="f_name">
                        </td>
                        <td></td>
                      </tr>
                      <tr height='22' style='mso-height-source:userset;height:16.5pt'>
                        <td colspan='4' height='20' class='x105' style='border-right:1px solid windowtext;border-bottom:2px solid windowtext;height:15pt;'>
                          <p>Admin Assistant-1</p>
                        </td>
