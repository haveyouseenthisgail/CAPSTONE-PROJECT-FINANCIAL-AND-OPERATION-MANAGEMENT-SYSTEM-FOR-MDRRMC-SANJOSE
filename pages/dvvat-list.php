                    ...
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped ">
                        ...
                        <tbody>
                          ...
                          $no = 1;
                          $query = mysqli_query($conn, "SELECT * FROM `tbl_dvvat` WHERE `dv_type`='dvvat' AND `dv_status`='pending' ORDER BY `dv_id` DESC ");
                          ...
                          ?>
                            <tr>
                              ...
                              <td class=" project-actions text-center">
                                ...
                                <!-- <a class="btn btn-info btn-sm" href="dvvat-edit.php?dv_id=<?php echo $dv_id; ?>&dv_type=<?php echo $dv_type; ?>&dv_status=<?php echo $dv_status; ?>">
                    ...
                    <div class="card-body">
                      <table id="example2" class="table table-bordered table-striped ">
                        ...
                        <tbody>
                          ...
                          $conn = new mysqli('localhost', 'root', '', 'mdrsystem');
                          $no = 1;
                          $query = mysqli_query($conn, "SELECT * FROM `tbl_dvvat` WHERE `dv_type`='dvvat' AND `dv_status`='Approved' ORDER BY `dv_id` DESC ");
                          while ($result = mysqli_fetch_array($query)) {
                            extract($result);
                    ...
                    <div class="card-body ">
                      <table id="example3" class="table table-bordered table-striped ">
                        ...
                        <tbody>
                          ...
                          $conn = new mysqli('localhost', 'root', '', 'mdrsystem');
                          $no = 1;
                          $query = mysqli_query($conn, "SELECT * FROM `tbl_dvvat` WHERE `dv_type`='dvvat' AND `dv_status`='Rejected' ORDER BY `dv_id` DESC ");
                          while ($result = mysqli_fetch_array($query)) {
                            extract($result);
