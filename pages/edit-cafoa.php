                  ...
                  <body link='blue' vlink='purple' class='x21'>
                    ...
                    <table border='0' cellpadding='0' cellspacing='0' width='706' style='border-collapse:collapse;
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td colspan='4' rowspan='4' height='80' class='x53' style='border-right:1px solid windowtext;height:60pt;    padding: 15px 0;'>
                          <textarea rows="3" name="cafoa__request" style="border: unset; outline: 0;text-align:center;overflow:hidden;font-size:13px; width:100%;resize:none;" 
                            class="general_update form-control"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__request"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>"><?php echo $cafoa__request ?></textarea>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td colspan='3' rowspan='2' height='40' class='x60' style='border-bottom:1px solid windowtext;height:30pt;'>
                          <textarea name="cafoa__payee" id="" oninput="textLimit(event, 120)" style="width: 16rem;border: unset;outline:0;font-weight: bold;font-size: 13px;resize:none;height:5rem;text-align:center;overflow:hidden;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__payee"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>"><?php echo $cafoa__payee ?> </textarea>
                        </td>
                        <td class='x29'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td colspan='2' class='x42' style='mso-ignore:colspan;border-right:1px solid windowtext;position:relative;'>
                          <p style="font-size: 14px;margin-left:5px;position:absolute">
                      ...
                      ?>
                        ...
                        <tr height='20' style='mso-height-source:userset;height:15pt;'>
                          <td height='18' class='x35' style='height:13.5pt;'><input type="text" value="<?php echo $function ?>" name="function[]" placeholder="f1" style="    width: 85px;height: 20px; font-size: 13px;border: unset;outline: 0;"
                              class="general_update"
                              data-table_db="tbl_cafoajoin"
                              data-column_up="function"
                              data-condition="cafoajoin"
                              data-identifier="<?php echo $result['cafoajoin']; ?>"></td>
                          <td class='x35'><input type="text" placeholder="Allotment1" value="<?php echo $allotment ?>" name="allotment[]" style="    width: 85px;height: 20px; font-size: 13px;border: unset;outline: 0;"
                              class="general_update"
                              data-table_db="tbl_cafoajoin"
                              data-column_up="allotment"
                              data-condition="cafoajoin"
                              data-identifier="<?php echo $result['cafoajoin']; ?>"></td>
                          <td class='x35'><input type="text" placeholder="Expense1" value="<?php echo $expense ?>" name="expense[]" style="    width: 85px;height: 20px; font-size: 13px;border: unset;outline: 0;"
                              class="general_update"
                              data-table_db="tbl_cafoajoin"
                              data-column_up="expense"
                              data-condition="cafoajoin"
                              data-identifier="<?php echo $result['cafoajoin']; ?>"></td>
                          <td class='x35'><input type="number" name="amount[]" value="<?php echo $amount ?>" placeholder="Amount1" style="    width: 85px;height: 20px; font-size: 13px;border: unset;outline: 0;"
                              class="general_update"
                              data-table_db="tbl_cafoajoin"
                              data-column_up="amount"
                              data-condition="cafoajoin"
                              data-identifier="<?php echo $result['cafoajoin']; ?>"></td>
                          <td class='x29'></td>
                          <td colspan='2' class='x25' style='mso-ignore:colspan;border-right:1px solid windowtext;'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td colspan='2' class='x45' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>
                          <input type="text" name="cafoa__budget" value="<?php echo $cafoa__budget ?>" maxlength="28" style="border:unset;outline:0;width:17rem;text-align:center;font-weight:bold;font-size:15px;height:18px;"

                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__budget"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td class='x27'><input type="date" name="cafoa__budgetdate" value="<?php echo $cafoa__budgetdate ?>" style="font-size: 14px;width:8.5rem;border:unset;outline:0;height:18px;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__budgetdate"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>"></td>
                        <td class='x21'></td>
                      </tr>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td colspan='2' class='x57' style='border-bottom:1px solid windowtext;border:unset;'>
                          <input type="number" id="cafoa__amountreq" name="cafoa__amountreq" value="<?php echo $cafoa__amountreq ?>"
                            ...
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__amountreq"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                        <td class='x29'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        <td colspan='4' height='19' class='x58' style='border-bottom:1px solid windowtext;height:14.25pt;'>
                          <input type="text" id="cafoa__amountwords" name="cafoa__amountwords" value="<?php echo $cafoa__amountwords ?>"
                            style="height: 19px; width: 21rem; border: unset; outline: 0; font-size: 13px; text-align:center;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__amountwords"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                        <td class='x29'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td colspan='2' class='x45' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>
                          <input type="text" name="cafoa__tresurer" value="<?php echo $cafoa__tresurer ?>" style="font-weight:bold;text-align:center;font-size:15px;width:16rem;border:unset;outline:0;height:17px;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__tresurer"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                        <td class='x21'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        <td colspan='5' height='20' class='x25' style='mso-ignore:colspan;border-right:1px solid windowtext;height:15pt;'></td>
                        <td class='x37'>&nbsp;Date</td>
                        <td class='x27'><input type="date" name="cafoa__tresurerdate" value="<?php echo $cafoa__tresurerdate ?>" style="    font-size: 14px; height: 18px; border: unset; outline: 0;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__tresurerdate"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>"></td>
                        <td class='x21'></td>
                      </tr>
                      <tr height='21' style='mso-height-source:userset;height:15.75pt'>
                        <td colspan='3' height='20' class='x43' style='mso-ignore:colspan;height:15pt;border-bottom:unset;'>
                          <input type="text" name="cafoa__requesting" value="<?php echo $cafoa__requesting ?>" placeholder="efe" style="    width: 13rem;border: unset;   border-bottom: 1px solid; outline: 0;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__requesting"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                        <td class='x38' style="border:unset;">
                          <input type="date" name="cafoa__requestingdate" value="<?php echo $cafoa__requestingdate ?>" style="width:94px;border:unset;border-bottom:1px solid"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__requestingdate"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                        <td class='x29'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        <td colspan='5' height='20' class='x25' style='mso-ignore:colspan;border-right:1px solid windowtext;height:15pt;'></td>
                        <td colspan='2' class='x45' style='border-right:1px solid windowtext;border-bottom:1px solid windowtext;'>
                          <input type="text" name="cafoa__accountant" value="<?php echo $cafoa__accountant ?>" style="font-weight:bold;text-align:center;font-size:15px;width:16rem;border:unset;outline:0;height:17px;" class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__accountant"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>">
                        </td>
                        <td class='x21'></td>
                      ...
                      <tr height='20' style='mso-height-source:userset;height:15pt'>
                        ...
                        <td class='x37'>Date:</td>
                        <td class='x27'><input type="date" name="cafoa__accountantdate" value="<?php echo $cafoa__accountantdate ?>" style="  font-size: 14px; height: 18px; border: unset; outline: 0;"
                            class="general_update"
                            data-table_db="tbl_cafoa"
                            data-column_up="cafoa__accountantdate"
                            data-condition="cafoa_id"
                            data-identifier="<?php echo $_GET['cafoa_id']; ?>"></td>
                        <td class='x21'></td>
                      </tr>
